        ...
        child: ListView(
          children: [
           ...
           style: const TextStyle(
            ...
            buildParagraph("Offence: Causing commotion, rudeness, disobedience of instruction from either an examination officer or invigilator."),
            ...
            buildParagraph("Offence: Disturbance and talking during examination."),
            buildParagraph("Penalty: Rustication for one semester.", isPenalty: true),
            buildParagraph("Offence: Writing rough work on a question paper or any other material other than the examination answer script provided."),
            buildParagraph("Penalty: Rustication for one semester.", isPenalty: true),
            buildParagraph("Offence: Taking into and/or using foreign material in the examination hall."),
            buildParagraph("Penalty: Expulsion from the University.", isPenalty: true),
            buildParagraph("Offence: Helping each other during examination."),
            buildParagraph("Penalty: Expulsion from the University.", isPenalty: true),
            buildParagraph("Offence: Verbal or physical assault on the examination officer, invigilator or fellow student (s)."),
            ...
            buildParagraph("Offence: Unauthorized use of programmable calculator and exchange of such calculators."),
            buildParagraph("Penalty: Expulsion from the University.", isPenalty: true),
            buildParagraph("Offence: Leaving the examination hall with an answer booklet."),
            buildParagraph("Penalty: Expulsion from the University.", isPenalty: true),
            buildParagraph("Offence: Entrance of examination hall with GSM handset."),
            buildParagraph("Penalty: Rustication for one semester.", isPenalty: true),
            buildParagraph("Offence: Use of GSM handset in the examination hall."),
            buildParagraph("Penalty: Expulsion from the University.", isPenalty: true),
            buildParagraph("Offence: Involvement of both staff and student in the leakage of any examination material."),
            ...
            buildParagraph("Offence: Stealing of examination material such as question paper, answer booklet, etc."),
