...
class FinalYearSecondSemester extends StatefulWidget {
  const FinalYearSecondSemester({Key? key, required this.title}) : super(key: key);
  final String title;
...
class FinalYearSecondSemesterState extends State<FinalYearSecondSemester> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const CourseHeader('EE523: SYSTEM RELIABILITY AND MAINTAINABILITY (2 UNITS)'),
              const CourseContent(
                title: '',
                content:
              ...
              const CourseHeader('CCE540: TELECOMMUNICATION SERVICES DESIGN (2 UNITS)'),
              const CourseContent(
                title: '',
                content:
              ...
              const CourseHeader('CCE526: DIGITAL COMMUNICATION SYSTEM (2 UNITS)'),
              const CourseContent(
                title: '',
                content:
              ...
              const CourseHeader('CCE527: IMAGE AND DATA TRANSMISSION SYSTEM (2 UNITS)'),
              const CourseContent(
                title: '',
                content:
  ...
  Future<void> _onLoadFlutterAsset(
    ...
    await controller.loadHtmlString(AppStrings.finalYearSecondSemester);
  }
}
