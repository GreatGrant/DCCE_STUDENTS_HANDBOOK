      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              CourseHeader('MTH 121: ELEMENTARY ALGEBRA II (4 UNITS)'),
              CourseContent(
                content:
              ...
              CourseHeader('MTH 122: CALCULUS II (4 UNITS)'),
              CourseContent(
                content:
              ...
              CourseHeader('PHY 126: INTRODUCTORY ELECTRICITY AND MAGNETISM (3 UNITS)'),
              CourseContent(
                title: 'Coulomb’s Law:',
          ...
          CourseContent(
            ...
            'Induced current and induced e.m.f. Energy conservation: Lenz’s law; Faraday’s law of electromagnetic induction; Force on moving electrons; Rotating coils; AC and DC generators; Electric motors; Eddy currents; The Transformer.',
              ...
              CourseHeader('PHY 172: BASIC EXPERIMENTAL PHYSICS II (1 UNIT)'),
              CourseContent(
                content:
                'A laboratory course covering basic experiments illustrative of the second semester 100 level physics syllabus.',
              ),
          CourseHeader('CHM 121 FOUNDATION CHEMISTRY II (3 UNITS)'),
          CourseContent(
            content:
          ...
          CourseHeader('GNS 112: USE OF ENGLISH II (2 UNITS)'),
          CourseContent(
            content:
          ...
          CourseHeader('GNS 222: NIGERIAN PEOPLE AND CULTURE IN THE CONTEXT OF AFRICAN HISTORY (2 UNITS)'),
          CourseContent(
            content:
            'The concept of history: what is history; its value, Source, materials for African history: written sources, unwritten sources, oral traditional, archaeological findings and linguistic evidence. The usefulness and limitations of written and unwritten sources.',
              ...
              CourseHeader('CS 142: INTRODUCTORY COMPUTER SCIENCE (3 UNITS)'),
              CourseContent(
                content:
